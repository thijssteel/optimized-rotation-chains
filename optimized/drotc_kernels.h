...
/**
 * @brief Kernel that applies n wavefronts of kr rotations to an mr x (n+kr)
 * matrix A. A should be packed, i.e. A should be in column-major format with
 * lda = mr. C and S should be in column major format with the same leading
 * dimension.
 *
 * @param n     integer
 ...
 *        A should be packed, i.e. A should be in column-major format with lda =
 * mr. This is a smaller kernel that is less efficient but is needed for edge
 * cases.
 *
 * @param n     integer
 *              The number of wavefronts to apply
...
/**
 * @brief Kernel that applies n wavefronts of kr rotations to an mr x (n+kr)
 * matrix A in backward direction. A should be packed, i.e. A should be in
 * column-major format with lda = mr. C and S should be in column major format
...
/**
 * @brief Kernel that applies n rotations to an mr x (n+1) matrix A in backward
 * direction. A should be packed, i.e. A should be in column-major format with
 * lda = mr. This is a smaller kernel that is less efficient but is needed for
 * edge cases.
 *
 * @param n     integer
 *              The number of wavefronts to apply
