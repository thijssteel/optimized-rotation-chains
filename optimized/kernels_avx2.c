                         ...
                         const double *restrict P)
{
    ...
    for (int i = 0; i < n; i++)
    {
        __m256d temp, c_vec, s_vec, a_next;
        ...
        c_vec = _mm256_set1_pd(P[kr + 0]);
        s_vec = _mm256_set1_pd(P[kr + 1]);
        ...
        c_vec = _mm256_set1_pd(P[2 * kr + 0]);
        s_vec = _mm256_set1_pd(P[2 * kr + 1]);
                         ...
                         const double *P)
{
    ...
    for (int i = 0; i < n; i++)
    {
        __m256d temp1, temp2, temp3, c_vec, s_vec, a_next;
                         ...
                         const float *restrict P)
{
    ...
    for (int i = 0; i < n; i++)
    {
        __m256 temp, c_vec, s_vec, a_next;
        ...
        // Apply rotation 1 to values 1 and 2 (next)
        c_vec = _mm256_set1_ps(P[kr + 0]);
        s_vec = _mm256_set1_ps(P[kr + 1]);
        ...
        // Apply rotation 2 to values 0 and 1 (next)
        c_vec = _mm256_set1_ps(P[2 * kr + 0]);
        s_vec = _mm256_set1_ps(P[2 * kr + 1]);
                         ...
                         const float *P)
{
    ...
    for (int i = 0; i < n; i++)
    {
        __m256 temp1, temp2, temp3, c_vec, s_vec, a_next;
