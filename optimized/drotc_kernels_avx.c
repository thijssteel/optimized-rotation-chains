...
void drotc_kernel_mrxnx1(int n, double* A, const double* C, const double* S)
{
    ...
    for (int i = 0; i < n; i++) {
        ...
        temp1 = _mm256_add_pd(_mm256_mul_pd(c_vec, a_0_1),
                              _mm256_mul_pd(s_vec, a_0_0));
        a_0_1 = _mm256_sub_pd(_mm256_mul_pd(c_vec, a_0_0),
                              _mm256_mul_pd(s_vec, a_0_1));

        temp2 = _mm256_add_pd(_mm256_mul_pd(c_vec, a_1_1),
                              _mm256_mul_pd(s_vec, a_1_0));
        a_1_1 = _mm256_sub_pd(_mm256_mul_pd(c_vec, a_1_0),
                              _mm256_mul_pd(s_vec, a_1_1));

        temp3 = _mm256_add_pd(_mm256_mul_pd(c_vec, a_2_1),
                              _mm256_mul_pd(s_vec, a_2_0));
        a_2_1 = _mm256_sub_pd(_mm256_mul_pd(c_vec, a_2_0),
                              _mm256_mul_pd(s_vec, a_2_1));
    ...
    int n, double* A, const double* C, int ldc, const double* S, int lds)
{
    ...
    for (int i = 0; i < n; i++) {
        ...
        temp = _mm256_add_pd(_mm256_mul_pd(c_vec, a_0_0),
                             _mm256_mul_pd(s_vec, a_0_1));
        a_0_0 = _mm256_sub_pd(_mm256_mul_pd(c_vec, a_0_1),
                              _mm256_mul_pd(s_vec, a_0_0));
        a_0_1 = temp;

        temp = _mm256_add_pd(_mm256_mul_pd(c_vec, a_1_0),
                             _mm256_mul_pd(s_vec, a_1_1));
        a_1_0 = _mm256_sub_pd(_mm256_mul_pd(c_vec, a_1_1),
                              _mm256_mul_pd(s_vec, a_1_0));
        a_1_1 = temp;

        temp = _mm256_add_pd(_mm256_mul_pd(c_vec, a_2_0),
                             _mm256_mul_pd(s_vec, a_2_1));
        a_2_0 = _mm256_sub_pd(_mm256_mul_pd(c_vec, a_2_1),
                              _mm256_mul_pd(s_vec, a_2_0));
        a_2_1 = temp;
        ...
        temp = _mm256_add_pd(_mm256_mul_pd(c_vec, a_0_0),
                             _mm256_mul_pd(s_vec, a_0_2));
        a_0_0 = _mm256_sub_pd(_mm256_mul_pd(c_vec, a_0_2),
                              _mm256_mul_pd(s_vec, a_0_0));
        a_0_2 = temp;

        temp = _mm256_add_pd(_mm256_mul_pd(c_vec, a_1_0),
                             _mm256_mul_pd(s_vec, a_1_2));
        a_1_0 = _mm256_sub_pd(_mm256_mul_pd(c_vec, a_1_2),
                              _mm256_mul_pd(s_vec, a_1_0));
        a_1_2 = temp;

        temp = _mm256_add_pd(_mm256_mul_pd(c_vec, a_2_0),
                             _mm256_mul_pd(s_vec, a_2_2));
        a_2_0 = _mm256_sub_pd(_mm256_mul_pd(c_vec, a_2_2),
                              _mm256_mul_pd(s_vec, a_2_0));
        a_2_2 = temp;
        ...
        temp = _mm256_add_pd(_mm256_mul_pd(c_vec, a_0_0),
                             _mm256_mul_pd(s_vec, a_0_3));
        a_0_0 = _mm256_sub_pd(_mm256_mul_pd(c_vec, a_0_3),
                              _mm256_mul_pd(s_vec, a_0_0));
        a_0_3 = temp;

        temp = _mm256_add_pd(_mm256_mul_pd(c_vec, a_1_0),
                             _mm256_mul_pd(s_vec, a_1_3));
        a_1_0 = _mm256_sub_pd(_mm256_mul_pd(c_vec, a_1_3),
                              _mm256_mul_pd(s_vec, a_1_0));
        a_1_3 = temp;

        temp = _mm256_add_pd(_mm256_mul_pd(c_vec, a_2_0),
                             _mm256_mul_pd(s_vec, a_2_3));
        a_2_0 = _mm256_sub_pd(_mm256_mul_pd(c_vec, a_2_3),
                              _mm256_mul_pd(s_vec, a_2_0));
        a_2_3 = temp;
...
void drotc_kernel_mrxnx1_backward(int n, double* A, const double* C, const double* S)
{
    ...
    for (int i = 0; i < n; i++) {
        ...
        temp1 = _mm256_sub_pd(_mm256_mul_pd(c_vec, a_0_0),
                              _mm256_mul_pd(s_vec, a_0_next));
        a_0_0 = _mm256_add_pd(_mm256_mul_pd(c_vec, a_0_next),
                              _mm256_mul_pd(s_vec, a_0_0));

        temp2 = _mm256_sub_pd(_mm256_mul_pd(c_vec, a_1_0),
                              _mm256_mul_pd(s_vec, a_1_next));
        a_1_0 = _mm256_add_pd(_mm256_mul_pd(c_vec, a_1_next),
                              _mm256_mul_pd(s_vec, a_1_0));

        temp3 = _mm256_sub_pd(_mm256_mul_pd(c_vec, a_2_0),
                              _mm256_mul_pd(s_vec, a_2_next));
        a_2_0 = _mm256_add_pd(_mm256_mul_pd(c_vec, a_2_next),
                              _mm256_mul_pd(s_vec, a_2_0));
