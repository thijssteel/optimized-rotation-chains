    ...
    int n, double* A, const double* C, int ldc, const double* S, int lds)
{
    ...
    // Load initial values of A
    __m256d a_0_1 = _mm256_loadu_pd(A);
    __m256d a_1_1 = _mm256_loadu_pd(&A[4]);
    __m256d a_2_1 = _mm256_loadu_pd(&A[8]);

    __m256d a_0_2 = _mm256_loadu_pd(&A[MR]);
    __m256d a_1_2 = _mm256_loadu_pd(&A[MR + 4]);
    __m256d a_2_2 = _mm256_loadu_pd(&A[MR + 8]);

    __m256d a_0_3 = _mm256_loadu_pd(&A[2 * MR]);
    __m256d a_1_3 = _mm256_loadu_pd(&A[2 * MR + 4]);
    __m256d a_2_3 = _mm256_loadu_pd(&A[2 * MR + 8]);

    for (int i = 0; i < n; i++) {
        __m256d temp, c_vec, s_vec;

        // Load new values of A
        __m256d a_0_0 = _mm256_loadu_pd(&A[-MR]);
        __m256d a_1_0 = _mm256_loadu_pd(&A[-MR + 4]);
        __m256d a_2_0 = _mm256_loadu_pd(&A[-MR + 8]);
        ...
        temp = _mm256_fmadd_pd(c_vec, a_0_0, _mm256_mul_pd(s_vec, a_0_1));
        a_0_0 = _mm256_fnmadd_pd(s_vec, a_0_0, _mm256_mul_pd(c_vec, a_0_1));
        a_0_1 = temp;

        temp = _mm256_fmadd_pd(c_vec, a_1_0, _mm256_mul_pd(s_vec, a_1_1));
        a_1_0 = _mm256_fnmadd_pd(s_vec, a_1_0, _mm256_mul_pd(c_vec, a_1_1));
        a_1_1 = temp;

        temp = _mm256_fmadd_pd(c_vec, a_2_0, _mm256_mul_pd(s_vec, a_2_1));
        a_2_0 = _mm256_fnmadd_pd(s_vec, a_2_0, _mm256_mul_pd(c_vec, a_2_1));
        a_2_1 = temp;
        ...
        temp = _mm256_fmadd_pd(c_vec, a_0_0, _mm256_mul_pd(s_vec, a_0_2));
        a_0_0 = _mm256_fnmadd_pd(s_vec, a_0_0, _mm256_mul_pd(c_vec, a_0_2));
        a_0_2 = temp;

        temp = _mm256_fmadd_pd(c_vec, a_1_0, _mm256_mul_pd(s_vec, a_1_2));
        a_1_0 = _mm256_fnmadd_pd(s_vec, a_1_0, _mm256_mul_pd(c_vec, a_1_2));
        a_1_2 = temp;

        temp = _mm256_fmadd_pd(c_vec, a_2_0, _mm256_mul_pd(s_vec, a_2_2));
        a_2_0 = _mm256_fnmadd_pd(s_vec, a_2_0, _mm256_mul_pd(c_vec, a_2_2));
        a_2_2 = temp;
        ...
        temp = _mm256_fmadd_pd(c_vec, a_0_0, _mm256_mul_pd(s_vec, a_0_3));
        a_0_0 = _mm256_fnmadd_pd(s_vec, a_0_0, _mm256_mul_pd(c_vec, a_0_3));
        a_0_3 = temp;

        temp = _mm256_fmadd_pd(c_vec, a_1_0, _mm256_mul_pd(s_vec, a_1_3));
        a_1_0 = _mm256_fnmadd_pd(s_vec, a_1_0, _mm256_mul_pd(c_vec, a_1_3));
        a_1_3 = temp;

        temp = _mm256_fmadd_pd(c_vec, a_2_0, _mm256_mul_pd(s_vec, a_2_3));
        a_2_0 = _mm256_fnmadd_pd(s_vec, a_2_0, _mm256_mul_pd(c_vec, a_2_3));
        a_2_3 = temp;

        // Store value 3 (stored in value 0)
        _mm256_storeu_pd(&A[2 * MR + 0], a_0_0);
        _mm256_storeu_pd(&A[2 * MR + 4], a_1_0);
        _mm256_storeu_pd(&A[2 * MR + 8], a_2_0);
    ...
    // Store final values of A
    _mm256_storeu_pd(&A[0], a_0_1);
    _mm256_storeu_pd(&A[4], a_1_1);
    _mm256_storeu_pd(&A[8], a_2_1);

    _mm256_storeu_pd(&A[MR + 0], a_0_2);
    _mm256_storeu_pd(&A[MR + 4], a_1_2);
    _mm256_storeu_pd(&A[MR + 8], a_2_2);

    _mm256_storeu_pd(&A[2 * MR + 0], a_0_3);
    _mm256_storeu_pd(&A[2 * MR + 4], a_1_3);
    _mm256_storeu_pd(&A[2 * MR + 8], a_2_3);
}
                                  ...
                                  const double* S)
{
    ...
    // Load initial values of A
    __m256d a_0_0 = _mm256_loadu_pd(&A[0]);
    __m256d a_1_0 = _mm256_loadu_pd(&A[4]);
    __m256d a_2_0 = _mm256_loadu_pd(&A[8]);
    ...
    for (int i = 0; i < n; i++) {
        ...
        temp1 = _mm256_fnmadd_pd(s_vec, a_0_next, _mm256_mul_pd(c_vec, a_0_0));
        a_0_0 = _mm256_fmadd_pd(c_vec, a_0_next, _mm256_mul_pd(s_vec, a_0_0));

        temp2 = _mm256_fnmadd_pd(s_vec, a_1_next, _mm256_mul_pd(c_vec, a_1_0));
        a_1_0 = _mm256_fmadd_pd(c_vec, a_1_next, _mm256_mul_pd(s_vec, a_1_0));

        temp3 = _mm256_fnmadd_pd(s_vec, a_2_next, _mm256_mul_pd(c_vec, a_2_0));
        a_2_0 = _mm256_fmadd_pd(c_vec, a_2_next, _mm256_mul_pd(s_vec, a_2_0));

        // Store value 0
        _mm256_storeu_pd(&A[0], temp1);
        _mm256_storeu_pd(&A[4], temp2);
        _mm256_storeu_pd(&A[8], temp3);
