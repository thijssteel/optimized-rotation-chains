...
!>          If trans = .TRUE., the conjugate transpose of the transformation is applied.
...
!> \ingroup rotc
!
subroutine zrotc(side, dir, startup, shutdown, trans,&
