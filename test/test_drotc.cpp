...
template <typename T>
void drotc_reference(bool startup,
                     bool shutdown,
                     bool trans,
                     int m,
                     int n,
                             ...
                             int lds))
{
    ...
    if (err < tol) {
        std::cout << "Test passed, m = " << m << ", n = " << n << ", k = " << k
                  << std::endl;
    }
    else {
        std::cout << "Test failed, m = " << m << ", n = " << n << ", k = " << k
                  << std::endl;
